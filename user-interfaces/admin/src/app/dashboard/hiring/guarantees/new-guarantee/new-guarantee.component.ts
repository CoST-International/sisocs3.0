...
@Component({
  selector: 'app-new-guarantee',
  templateUrl: './new-guarantee.component.html',
  styleUrls: ['./new-guarantee.component.scss']
})
export class NewGuaranteeComponent implements OnInit {
  ...
  warantyTypes = [
    {
      id: 1,
      title: 'ADVANCE GUARANTEE'
    },
    {
      id: 1,
      title: 'OFFER MAINTENANCE GUARANTEE'
    },
    {
      id: 1,
  ...
  setUpGuaranteeForm(): void {
    this.guaranteeForm = this.fb.group({
      'project_id': ['', []], // Validators.required
      'expiration_date': ['', []], // Validators.required
      'currency': ['', []], // Validators.required
      'amount': ['', []], // Validators.required
      'waranty_type': ['', []], // Validators.required
    });

    this.filteredProjects = this.guaranteeForm.get('project_id')?.valueChanges
      .pipe(
        startWith(null),
  ...
  saveGuarantee(formValue: FormGroup, stepper: MatStepper) {
  ...
  private _filter(value: any): any[] {
    ...
    return this.projects.filter(option => (option.process_number_standard != null ? option.process_number_standard.toLowerCase().indexOf(process_number.toLowerCase()) === 0 : null));
  }
