...
@Component({
  selector: 'app-new-disbursement',
  templateUrl: './new-disbursement.component.html',
  styleUrls: ['./new-disbursement.component.scss']
})
export class NewDisbursementComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.setUpDisbursementForm();
  }

  setUpDisbursementForm(): void {
    ...
    this.filteredProjects = this.disbursementForm.get('project_id')?.valueChanges
    .pipe(
      startWith(null),
  ...
  saveDisbursement(formValue: FormGroup) {
