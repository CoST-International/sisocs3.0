...
The Information and Monitoring System for Supervision Works and Contracts (SISOCS) was created as a subsystem of the State Hiring and Procurement System, Honduomrpas, which operates in the Ministry of Infrastructure and Public Services (INSEP).

Through SISOCS, you can view physical and financial progress of the works, you also get a summary with basic information on project planning, procurement processes, contract management, photos, and geographic location of the projects. You can also download related public information in various formats including xlsx, csv and JSON.
