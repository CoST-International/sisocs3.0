...
The SISOCS discloses all data points contained in both CoST IDS proactive and reactive tables plus several items identified as key data points by different stakeholders.
